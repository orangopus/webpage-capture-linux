...
Compress the `entry.tp` file in its own `webpage-capture-linux.tpp` zip folder.
...
- **Jordan Nickless** - _Porting it to Linux_ - [CHEESEvsCODE](https://github.com/CHEESEvsCODE)
